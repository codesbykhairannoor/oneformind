                        ...
                        >
                            ...
                            {!isSidebarCollapsed && (
                                <>
                                    ...
                                    <span className="text-[8px] font-black text-emerald-700 dark:text-emerald-300 uppercase bg-emerald-100 dark:bg-emerald-500/20 px-1.5 py-0.5 rounded-full shrink-0 tracking-wider">
                                        ADMIN
                                    </span>
                                </>
                            )}
