...
export default function NeuralBridge({ module }: NeuralBridgeProps) {
    ...
    const [synergy, setSynergy] = useState<string | null>(
        `Berdasarkan analisis aktivitas ${module}, pola produktivitas kamu sedang berada pada performa puncaknya (Peak Synergy Score: 94%).`
    );
