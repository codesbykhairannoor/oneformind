...
export default function AffiliatesPage() {
    ...
    // If logged in, redirect directly to Settings tab affiliate as requested
    useEffect(() => {
        if (session?.user) {
            router.replace('/settings?tab=affiliate');
        }
    }, [session, router]);
    ...
    // If session is present, show small loader while router.replace executes
    if (session?.user) {
        return (
                ...
                <header className="pt-32 pb-20 px-6 relative text-center">
                    ...
                    <div className="max-w-5xl mx-auto space-y-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
                            ...
                            <Link
                                href="/register?next=/settings?tab=affiliate"
