...
export default function JournalEditorHeader({
    ...
    return (
        <header className={`sticky top-0 z-50 border-b px-4 sm:px-6 py-3.5 flex flex-wrap items-center justify-between gap-3 shadow-sm transition-all duration-300 ${
            ...
            <div className="flex items-center gap-1 sm:gap-1.5 justify-start sm:justify-center overflow-x-auto no-scrollbar w-full sm:w-auto order-3 sm:order-2 py-1 sm:py-0 border-t sm:border-t-0 border-slate-100 dark:border-slate-800">
                {/* Bold */}
                <button
                    type="button"
                    onClick={() => {
                    ...
                    className={`w-8 h-8 sm:w-9 sm:h-9 rounded-xl flex items-center justify-center transition-all active:scale-95 shrink-0 ${
                ...
                <button
                    ...
                    className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl flex items-center justify-center hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 transition-all active:scale-95 shrink-0"
                ...
                >
                    <CheckSquare className="w-3.5 h-3.5 sm:w-4 sm:h-4 stroke-[2.5]" />
                </button>

                <div className="w-px h-5 sm:h-6 bg-slate-200 dark:bg-slate-800 mx-1 self-center shrink-0" />
                ...
                <div className="relative shrink-0">
                    <button
                        ...
                        className="h-8 sm:h-9 px-2 rounded-xl flex items-center gap-1 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all text-slate-600 dark:text-slate-300 font-bold text-xs active:scale-95"
                ...
                >
                    {isPrivacyBlur ? <EyeOff className="w-3.5 h-3.5 sm:w-4 sm:h-4 stroke-[2.5]" /> : <Eye className="w-3.5 h-3.5 sm:w-4 sm:h-4 stroke-[2.5]" />}
                </button>
                ...
                >
                    {isListening ? <MicOff className="w-3.5 h-3.5 sm:w-4 sm:h-4 stroke-[2.5]" /> : <Mic className="w-3.5 h-3.5 sm:w-4 sm:h-4 stroke-[2.5]" />}
                </button>
            ...
            <div className="flex items-center gap-3 order-2 sm:order-3 ml-auto sm:ml-0">
                <button
                    ...
                    onClick={handleSave}
                    disabled={isSaving}
                    className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white text-xs font-black tracking-wide px-3.5 sm:px-5 py-2 rounded-xl shadow-lg shadow-indigo-500/25 active:scale-95 disabled:opacity-50 flex items-center gap-1.5 sm:gap-2 transition-all"
                >
                    <Save className="h-4 w-4" />
                    <span>{isSaving ? (isIndo ? 'Menyimpan...' : 'Saving...') : (isIndo ? 'Simpan' : 'Save')}</span>
                </button>
            </div>
        </header>
    );
