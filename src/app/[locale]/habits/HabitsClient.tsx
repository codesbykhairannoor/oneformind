    ...
    return (
        <AuthenticatedLayout>
            <div className="min-h-screen bg-slate-50/50 dark:bg-slate-950/50 transition-colors duration-500">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center justify-between gap-2">
                                                ...
                                                <div className="flex items-center gap-1">
                                                    <button onClick={(e) => { e.preventDefault(); e.stopPropagation(); editHabit(habit); }} className="p-2 text-slate-400 dark:text-slate-500 hover:text-indigo-500 bg-slate-50 dark:bg-slate-800/50 rounded-lg" aria-label="Edit Habit">
                                                        <Edit3 size={14} />
                                                    </button>
                                                    <button onClick={(e) => { e.preventDefault(); e.stopPropagation(); confirmDelete(habit); }} className="p-2 text-slate-400 dark:text-slate-500 hover:text-rose-500 bg-slate-50 dark:bg-slate-800/50 rounded-lg" aria-label="Delete Habit">
                                                        <Trash2 size={14} />
                                                    </button>
                                                </div>
                                            </div>
                    ...
                    <div className="hidden md:block bg-white dark:bg-transparent md:rounded-[2.5rem] shadow-sm md:shadow-[0_2px_20px_rgba(0,0,0,0.04)] dark:shadow-none border border-slate-100 dark:border-transparent overflow-hidden relative">
                        <div className="overflow-x-auto custom-scrollbar relative select-none">
                            ...
                            <div className="sticky top-0 z-30 bg-white dark:bg-transparent border-b border-slate-100 dark:border-slate-800/50 flex shadow-sm dark:shadow-none">
                                <div className="sticky left-0 z-40 bg-white dark:bg-slate-950 w-72 shrink-0 border-r border-slate-100 dark:border-slate-800/50 p-4 flex items-center font-bold text-slate-400 dark:text-slate-500 text-xs capitalize shadow-[10px_0_20px_rgba(0,0,0,0.02)] dark:shadow-[10px_0_20px_rgba(0,0,0,0.2)]">
                                ...
                                <div className="flex shrink-0 sticky right-0 z-40 bg-white dark:bg-slate-950 w-32 p-4 border-l border-slate-100 dark:border-slate-800/50 items-center justify-end font-bold text-slate-400 dark:text-slate-500 text-xs capitalize shadow-[-10px_0_20px_rgba(255,255,255,0.8)] dark:shadow-none">
                                    Total Log
                                </div>
                            </div>
                            ...
                            <div className="divide-y divide-slate-50 dark:divide-slate-800">
                                {processedHabits.map(habit => (
                                    <div key={habit.id} className="flex transition-colors duration-200 group relative bg-white dark:bg-transparent hover:bg-slate-50 dark:hover:bg-slate-800/50">
                                        
                                        {/* Left Sticky Info */}
                                        <div className="sticky left-0 z-30 w-72 shrink-0 bg-white dark:bg-slate-950 group-hover:bg-slate-50 dark:group-hover:bg-slate-900 border-r border-slate-100 dark:border-slate-800/50 p-4 flex items-center gap-3 shadow-[10px_0_20px_rgba(0,0,0,0.02)] dark:shadow-[10px_0_20px_rgba(0,0,0,0.2)]">
                                        ...
                                        <div className="flex shrink-0 sticky right-0 z-30 w-32 bg-white dark:bg-slate-950 group-hover:bg-slate-50 dark:group-hover:bg-slate-900 border-l border-slate-100 dark:border-slate-800/50 p-4 flex-col justify-center shadow-[-10px_0_20px_rgba(255,255,255,0.8)] dark:shadow-none">
                ...
                {showBatchModal && (
                    <ModalPortal><div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                        <div className="absolute inset-0 bg-slate-950/50 " onClick={() => setShowBatchModal(false)} />
                ...
                {showCopyModal && (
                    <ModalPortal><div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                        <div className="absolute inset-0 bg-slate-950/50 " onClick={() => setShowCopyModal(false)} />
