...
export default function AsanaComparePage() {
    ...
    const faqs = [
        ...
        {
            q: 'Mengapa Asana terlalu kompleks untuk produktivitas individu?',
    ...
    return (
        <GuestLayout>
            <main id="asana-compare" className="overflow-x-hidden">
                {/* SECTION 1: HERO (Text Left, Minimalist UI Right, Indigo-50 Theme) */}
                <header className="pt-32 pb-24 px-6 bg-indigo-50 relative overflow-hidden border-b border-indigo-100">
                    <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center relative z-10">
                        <div className="lg:col-span-7 text-left">
                            ...
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white text-indigo-600 font-bold text-xs mb-8 uppercase tracking-wider shadow-sm border border-indigo-100">
                                🦄 {t('asana_badge')}
                            </div>
                            
                            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-slate-900 mb-6 tracking-tight leading-tight">
                                {t('asana_hero_title_1')} <br/>
                                <span className="text-indigo-600">{t('asana_hero_title_2')}</span>
                            </h1>
                            
                            <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-xl" dangerouslySetInnerHTML={{ __html: t.raw('asana_hero_desc') }} />
                            
                            <div className="flex flex-col sm:flex-row items-start gap-4">
                                <Link href="/register" className="bg-indigo-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-indigo-700 hover:shadow-lg hover:shadow-indigo-300 transition-all transform hover:-translate-y-1">
                                    {t('asana_hero_cta')}
                                </Link>
                                <span className="text-sm text-slate-500 font-medium py-4">{t('asana_hero_note')}</span>
                            </div>
                        </div>
                ...
                <section className="py-8 px-6 bg-slate-800 border-b border-slate-700">
                    ...
                    <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', fontWeight: 800, lineHeight: 1.2 }} className="text-slate-900 mb-6">
                                {t('asana_prob_title_1')} <span className="text-indigo-600">{t('asana_prob_title_highlight')}</span>
                            </h2>
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-center gap-3 text-slate-700 font-medium">
                                    ...
                                    {t('asana_prob_point_1')}
                                </li>
                                <li className="flex items-center gap-3 text-slate-700 font-medium">
                                    <div className="w-6 h-6 rounded-full bg-red-100 text-red-600 flex items-center justify-center text-xs">✕</div>
                                    {t('asana_prob_point_2')}
                                </li>
                                <li className="flex items-center gap-3 text-slate-700 font-medium">
                                    <div className="w-6 h-6 rounded-full bg-red-100 text-red-600 flex items-center justify-center text-xs">✕</div>
                                    {t('asana_prob_point_3')}
                                </li>
                            </ul>
                        </div>
                ...
                <section className="py-[80px] px-6 bg-indigo-50">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', fontWeight: 800, lineHeight: 1.2 }} className="text-slate-900 mb-6">
                                {t('asana_sol_title_1')} <span className="text-indigo-600">{t('asana_sol_title_highlight')}</span>
                            </h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="bg-white p-8 rounded-3xl shadow-sm border border-indigo-100 hover:shadow-md transition-shadow">
                                ...
                                <h3 className="text-2xl font-bold text-slate-900 mb-3">{t('asana_sol_1_title')}</h3>
                                <p className="text-slate-600">{t('asana_sol_1_desc')}</p>
                            </div>
                            <div className="bg-white p-8 rounded-3xl shadow-sm border border-indigo-100 hover:shadow-md transition-shadow">
                                <div className="w-12 h-12 bg-indigo-600 text-white rounded-xl flex items-center justify-center text-xl mb-6 shadow-indigo-200 shadow-lg">⚡</div>
                                <h3 className="text-2xl font-bold text-slate-900 mb-3">{t('asana_sol_2_title')}</h3>
                                <p className="text-slate-600">{t('asana_sol_2_desc')}</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', fontWeight: 800, lineHeight: 1.2 }} className="text-slate-900 mb-4">
                                {t('asana_compare_title')}
                            </h2>
                            <p style={{ fontSize: '1.15rem', lineHeight: 1.8 }} className="text-slate-500">
                                {t('asana_compare_desc')}
                            </p>
                        </div>
                            ...
                            <table className="w-full text-left border-collapse">
                                ...
                                <tbody className="text-slate-700">
                                    <tr className="group hover:bg-slate-50 transition-colors">
                                        <td className="p-4 border-b border-slate-100 font-semibold">{t('asana_table_row_1_title')}</td>
                                        <td className="p-4 border-b border-slate-100 text-slate-500">{t('asana_table_row_1_col_1')}</td>
                                        <td className="p-4 border-b border-indigo-100 font-bold text-indigo-700 bg-indigo-50/50">
                                            <div className="flex items-center gap-2">
                                                <span className="text-indigo-500">✓</span> {t('asana_table_row_1_col_2')}
                                            </div>
                                        </td>
                                    </tr>
                                    <tr className="group hover:bg-slate-50 transition-colors">
                                        <td className="p-4 border-b border-slate-100 font-semibold">{t('asana_table_row_2_title')}</td>
                                        <td className="p-4 border-b border-slate-100 text-slate-500">{t('asana_table_row_2_col_1')}</td>
                                        <td className="p-4 border-b border-indigo-100 font-bold text-indigo-700 bg-indigo-50/50">
                                            <div className="flex items-center gap-2">
                                                <span className="text-indigo-500">✓</span> {t('asana_table_row_2_col_2')}
                                            </div>
                                        </td>
                                    </tr>
                                    <tr className="group hover:bg-slate-50 transition-colors">
                                        <td className="p-4 border-b border-slate-100 font-semibold">{t('asana_table_row_3_title')}</td>
                                        <td className="p-4 border-b border-slate-100 text-slate-500">{t('asana_table_row_3_col_1')}</td>
                                        <td className="p-4 border-b border-indigo-100 font-bold text-indigo-700 bg-indigo-50/50 rounded-b-xl">
                                            <div className="flex items-center gap-2">
                                                <span className="text-indigo-500">✓</span> {t('asana_table_row_3_col_2')}
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                        <div className="order-2 md:order-1">
                            <div className="p-8 bg-slate-800 rounded-3xl border border-slate-700">
                                <h3 className="text-2xl font-bold mb-4 text-indigo-400">{t('asana_psycho_title')}</h3>
                                <p className="text-slate-300 leading-relaxed">{t('asana_psycho_desc')}</p>
                            </div>
                        </div>
                ...
                <section className="py-[80px] px-6 bg-white text-center">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <p className="text-xl text-slate-500 mb-10">{t('asana_cta_desc')}</p>
